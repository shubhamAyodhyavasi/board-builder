 ...
 * plugin.
 *
 * @package BoradBuilder\Includes
 */

spl_autoload_register( 'boardbuilder_autoload' );
 ...
 */
function boardbuilder_autoload( $class_name ) {

    // If the specified $class_name does not include our namespace, duck out.
    if ( false === strpos( $class_name, 'BoradBuilder' ) ) {
        return;
    }
